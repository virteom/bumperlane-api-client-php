...
"To": "phil.carbone@virteom.com",
"From": "phil.carbone@virteom.com",
...
<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\"><title>DIY-IT: Top 10 how-to articles of 2016</title><link rel=\"stylesheet\" href=\"https://secure-fly.zdnet.com/bundles/zdnetcss/css/newsletter/newsletter.css\"><!--[if
...
$data = json_decode(str_replace("\r", "\\r", str_replace("\n", "\\n", $json)), true);
var_dump($data);
$result = $request->Post($data);

//echo $twig->render('send-email.html', array("data" => $result));